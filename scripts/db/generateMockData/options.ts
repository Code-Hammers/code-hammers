export const profilePicOptions = [
  'https://static.miraheze.org/greatcharacterswiki/e/e1/TheDude.jpg',
  'https://www.codesmith.io/hubfs/Gabriela%20%20Small.png',
  ...
  'https://i.ytimg.com/vi/z6EchXyieos/maxresdefault.jpg',
  'https://t3.ftcdn.net/jpg/05/90/55/44/360_F_590554438_4aX0I6HFMplsFtBpQwN9OJEUakR87R88.jpg',
];

export const cohorts = ['LA', 'NYC', 'ECRI', 'PTRI', 'WCRI', 'FTRI', 'CTRI'];

export const cohortNumRange = 100;
...
export const professionalSummaryOptions = [
...
export const postContentOptions = [
