...
const Profile = () => {
  ...
  return (
    ...
    {socialMediaLinks?.twitter && isValidUrl(socialMediaLinks.twitter) && (
      <a href={ensureProtocol(socialMediaLinks.twitter)} target="_blank" rel="noopener noreferrer">
        <img src={twitterLogo} alt="Twitter" />
      </a>
    )}

    {socialMediaLinks?.blog && isValidUrl(socialMediaLinks.blog) && (
      <a href={ensureProtocol(socialMediaLinks.blog)} target="_blank" rel="noopener noreferrer">
